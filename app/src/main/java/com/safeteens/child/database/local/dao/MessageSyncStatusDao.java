...
import static com.safeteens.child.database.local.constants.TableName.MESSAGE_READ_CHECKPOINTS;
import static com.safeteens.child.database.local.constants.TableName.MESSAGE_SYNC_STATUS;
