package com.safeteens.child.database.firebase.firestoreDao;

import com.google.firebase.firestore.CollectionReference;
import com.safeteens.child.database.firebase.FirebaseServiceInterfaces;
import com.safeteens.child.database.local.entities.Entity;
import io.reactivex.Observable;
import static com.safeteens.child.database.firebase.FirestoreService.writeObjectToDocumentRef;
