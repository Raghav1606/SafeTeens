package com.safeteens.child.database.local.entities;
...
import com.safeteens.child.database.local.constants.TableName;
import com.safeteens.child.database.local.typeConverters.DateConverter;
import com.safeteens.child.database.local.typeConverters.SourceConverter;
...
@Getter
@Setter
public class MessageReadCheckpoint extends com.safeteens.child.database.local.entities.Entity {
