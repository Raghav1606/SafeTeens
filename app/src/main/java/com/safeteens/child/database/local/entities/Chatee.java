...
import com.safeteens.child.database.local.typeConverters.ChateeTypeConverter;
...
public class Chatee extends com.safeteens.child.database.local.entities.Entity {
